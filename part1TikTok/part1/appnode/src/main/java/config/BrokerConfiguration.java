...
public class BrokerConfiguration {
    ...
    public static String BROKER_IP_1 = "192.168.1.6";
    public static String BROKER_IP_2 = "192.168.1.6";
    public static String BROKER_IP_3 = "192.168.1.6";

    public static int BROKER_PORT_1 = 14004;
    public static int BROKER_PORT_2 = 58023;
    public static int BROKER_PORT_3 = 14898;
